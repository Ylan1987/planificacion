...
// --- Componente del Formulario (Autónomo y Corregido) ---
        ...
        <div className="card card-edit inline-form">
            ...
            <div className="card-content">
                <div className="form-section">
                    ...
                    <input type="text" value={machine.name} onChange={(e) => handleFieldChange('name', e.target.value)} autoFocus />
                </div>
                    ...
                    <div key={taskIndex} className="task-rule-form">
                        <div className="form-row space-between">
                            <div className="custom-select" style={{flex: 1}}>
                                <select value={task.task_id} onChange={(e) => handleTaskChange(taskIndex, 'task_id', e.target.value)}>
